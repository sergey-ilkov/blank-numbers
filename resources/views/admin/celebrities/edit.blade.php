        ...
        <div class="content__item">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <x-admin.form action="{{ route('celebrities.update', $celebrity['id']) }}" enctype="multipart/form-data" method="PATCH"
                        class="card-form">
                            ...
                            <div class="card-body-language">
                                    ...
                                    <div class="card-body__group card-body-col">
                                        <x-admin.form-item>
                                            ...
                                            <x-admin.input name="name_{{ $language->code }}"
                                                value="{{ $celebrity['name_' . $language->code ] }}" />
                                        </x-admin.form-item>
                                    </div>
                                    <div class="card-body__group card-body-col">
                                        <x-admin.form-item>
                                            ...
                                            <x-admin.input name="surname_{{ $language->code }}"
                                                value="{{ $celebrity['surname_' . $language->code ] }}" />
                                        </x-admin.form-item>
                                    </div>
                                </div>
                                ...
                                <div class=" card-body__group">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input name="gender_{{ $language->code }}"
                                            value="{{ $celebrity['gender_' . $language->code ] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                            ...
                            <div id="square-inputs" class="card-body-row row-start">
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="square-input-day" type="number" name="day" value="{{ $celebrity['day'] }}"
                                ...
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="square-input-month" type="number" name="month" value="{{ $celebrity['month'] }}"
                                            style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="square-input-year" type="number" name="year" value="{{ $celebrity['year'] }}"
                                            style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                            </div>
                                ...
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras__num-1" type="number" name="extra_number_one"
                                            value="{{ $square['extra_number_one'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras__num-2" type="number" name="extra_number_two"
                                            value="{{ $square['extra_number_two'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras__num-3" type="number" name="extra_number_three"
                                            value="{{ $square['extra_number_three'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras__num-4" type="number" name="extra_number_four"
                                            value="{{ $square['extra_number_four'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                            </div>
                                ...
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras-matrix__num-1" type="number" name="number_one"
                                            value="{{ $square['number_one'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras-matrix__num-4" type="number" name="number_four"
                                            value="{{ $square['number_four'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras-matrix__num-7" type="number" name="number_seven"
                                            value="{{ $square['number_seven'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                ...
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras-matrix__num-2" type="number" name="number_two"
                                            value="{{ $square['number_two'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras-matrix__num-5" type="number" name="number_five"
                                            value="{{ $square['number_five'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras-matrix__num-8" type="number" name="number_eight"
                                            value="{{ $square['number_eight'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                ...
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras-matrix__num-3" type="number" name="number_three"
                                            value="{{ $square['number_three'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras-matrix__num-6" type="number" name="number_six"
                                            value="{{ $square['number_six'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras-matrix__num-9" type="number" name="number_nine"
                                            value="{{ $square['number_nine'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                            ...
                            <div class="card-body-row row-start gap-20">
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras__num-5" type="number" name="goal" value="{{ $square['goal'] }}"
                                            style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras__num-6" type="number" name="family" value="{{ $square['family'] }}"
                                            style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras__num-7" type="number" name="habits" value="{{ $square['habits'] }}"
                                            style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras__num-8" type="number" name="self_esteem"
                                            value="{{ $square['self_esteem'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        <x-admin.label> {{__('everyday_life')}} </x-admin.label>
                                        <x-admin.input id="pythagoras__num-9" type="number" name="everyday_life"
                                            value="{{ $square['everyday_life'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        <x-admin.label> {{__('talents')}} </x-admin.label>
                                        <x-admin.input id="pythagoras__num-10" type="number" name="talents" value="{{ $square['talents'] }}"
                                            style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        ...
                                        <x-admin.input id="pythagoras__num-11" type="number" name="spirituality"
                                            value="{{ $square['spirituality'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                <div class="card-body__group card-body-col">
                                    <x-admin.form-item>
                                        <x-admin.label> {{__('temperament')}} </x-admin.label>
                                        <x-admin.input id="pythagoras__num-12" type="number" name="temperament"
                                            value="{{ $square['temperament'] }}" style="max-width: 100px" />
                                    </x-admin.form-item>
                                </div>
                                    ...
                                    <div class="select-groups__item">
                                        ...
                                        <div class="select-show @error('occupations') error @enderror">
                                            <ul class="select-show__list">
                                                ...
                                                <li class="select-show__item" data-id="{{ $occupation->id }}"
                                                    data-name="{{ $occupation->title_uk}}">
                                    ...
                                    <div class="select-groups__item">
                                        ...
                                        <div class="select-show @error('movies') error @enderror">
                                            <ul class="select-show__list">
                                                ...
                                                <li class="select-show__item" data-id="{{ $movie->id }}"
                                    ...
                                    <div class="select-groups__item">
                                        ...
                                        <div class="select-show @error('celebrities') error @enderror">
                                            <ul class="select-show__list">
                                                ...
                                                <li class="select-show__item" data-id="{{ $connection->id }}"
                                                    data-name="{{ $connection->surname_uk . ' ' . $connection->name_uk  . ' '. $connection->year }}">
