        ...
        <div class="content__item">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <x-admin.form action="{{ route('actors.store') }}" enctype="multipart/form-data" method="POST" class="card-form">
                        ...
                        <div class="card-body__group">
                            ...
                            <x-admin.form-item>
                                ...
                                <x-admin.input name="name_{{ $language->code }}" style="max-width: 300px" />
                            ...
                            <x-admin.form-item>
                                ...
                                <x-admin.input name="surname_{{ $language->code }}" style="max-width: 300px" />
