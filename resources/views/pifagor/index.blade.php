                ...
                <div id="square-pythagoras" class="square-pythagoras">
                    ...
                    <div class="square-pythagoras-data">
                        <div class="square-pythagoras__group">
                            <label class="square-pythagoras__label" for="square-pythagoras-name">
                                {{ __('translations.pifagor.name')}}
                            </label>
                            <input id="square-pythagoras-name" class="square-pythagoras__input" type="text"
                                placeholder="{{ __('translations.pifagor.name') }}" name="name" autocomplete="off" spellcheck="false">
                        </div>
                        <div class="square-pythagoras__group">
                            <label class="square-pythagoras__label" for="square-pythagoras-date">{{ __('translations.pifagor.birthday')
                                }}</label>
                            <input id="square-pythagoras-date" class="square-pythagoras__input" type="text" placeholder="31.12.2001"
            ...
            <div class="pythagoras__item">
                <div class="pythagoras-content">
                    ...
                    <div class="pythagoras-btn-anim">
                        <a class="pythagoras__link btn btn-2" href="{{ route('home') }}/#consultations">{{ __('base.buttonConsultation')
                            }}</a>
                    </div>
                </div>
